<template>
  <div
    class="flex h-[618px] w-full max-w-screen-xxl items-center text-4xl font-medium"
  >
    <div
      class="fixed top-0 -z-10 flex h-[618px] w-full max-w-screen-xxl items-center justify-center rounded-b-[45px] xxl:px-[1px]"
    >
